...
`].filter(va).join(`
`)),a=_u(a),a=bp(a,e),a=Tp(a,e),o=_u(o),o=bp(o,e),o=Tp(o,e),a=Ep(a),o=Ep(o),e.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
`)+`
`+m);let M=y+p+a,S=y+m+o,w=yp(i,i.VERTEX_SHADER,M),E=yp(i,i.FRAGMENT_SHADER,S);i.attachShader(_,w),i.attachShader(_,E),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function C(R){if(s.debug.checkShaderErrors){let L=i.getProgramInfoLog(_)||"",B=i.getShaderInfoLog(w)||"",V=i.getShaderInfoLog(E)||"",N=L.trim(),O=B.trim(),z=V.trim(),$=!0,j=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if($=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,w,E);else{let ot=Sp(i,w,"vertex"),mt=Sp(i,E,"fragment");wt("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`,Ky=[new I(1,0,0),new I(-1,0,0),new I(0,1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1)],Qy=[new I(0,-1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1),new I(0,-1,0),new I(0,-1,0)],Pp=new me,xa=new I,fu=new I;function jy(s,t,e){let n=new Zr,i=new Tt,r=new Tt,a=new Me,o=new Jo,l=new $o,c={},h=e.maxTextureSize,f={[gi]:ze,[ze]:gi,[An]:An},u=new _n({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Tt},radius:{value:4}},vertexShader:Jy,fragmentShader:$y}),d=u.clone();d.defines.HORIZONTAL_PASS=1;let g=new Be;g.setAttribute("position",new Ze(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let _=new Ne(g,u),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=la;let m=this.type;this.render=function(E,C,x){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||E.length===0)return;this.type===Ed&&(Et("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=la);let T=s.getRenderTarget(),P=s.getActiveCubeFace(),R=s.getActiveMipmapLevel(),L=s.state;L.setBlending(Kn),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);let B=m!==this.type;B&&C.traverse(function(V){V.material&&(Array.isArray(V.material)?V.material.forEach(N=>N.needsUpdate=!0):V.material.needsUpdate=!0)});for(let V=0,N=E.length;V<N;V++){let O=E[V],z=O.shadow;if(z===void 0){Et("WebGLShadowMap:",O,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);let $=z.getFrameExtents();i.multiply($),r.copy(z.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/$.x),i.x=r.x*$.x,z.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/$.y),i.y=r.y*$.y,z.mapSize.y=r.y));let j=s.state.buffers.depth.getReversed();if(z.camera._reversedDepth=j,z.map===null||B===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===sr){if(O.isPointLight){Et("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new gn(i.x,i.y,{format:Ji,type:Qn,minFilter:Oe,magFilter:Oe,generateMipmaps:!1}),z.map.texture.name=O.name+".shadowMap",z.map.depthTexture=new xi(i.x,i.y,Fn),z.map.depthTexture.name=O.name+".shadowMapDepth",z.map.depthTexture.format=Zn,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Le,z.map.depthTexture.magFilter=Le}else O.isPointLight?(z.map=new jl(i.x),z.map.depthTexture=new zo(i.x,Un)):(z.map=new gn(i.x,i.y),z.map.depthTexture=new xi(i.x,i.y,Un)),z.map.depthTexture.name=O.name+".shadowMap",z.map.depthTexture.format=Zn,this.type===la?(z.map.depthTexture.compareFunction=j?Jl:Zl,z.map.depthTexture.minFilter=Oe,z.map.depthTexture.magFilter=Oe):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Le,z.map.depthTexture.magFilter=Le);z.camera.updateProjectionMatrix()}let ot=z.map.isWebGLCubeRenderTarget?6:1;for(let mt=0;mt<ot;mt++){if(z.map.isWebGLCubeRenderTarget)s.setRenderTarget(z.map,mt),s.clear();else{mt===0&&(s.setRenderTarget(z.map),s.clear());let vt=z.getViewport(mt);a.set(r.x*vt.x,r.y*vt.y,r.x*vt.z,r.y*vt.w),L.viewport(a)}if(O.isPointLight){let vt=z.camera,Vt=z.matrix,Bt=O.distance||vt.far;Bt!==vt.far&&(vt.far=Bt,vt.updateProjectionMatrix()),xa.setFromMatrixPosition(O.matrixWorld),vt.position.copy(xa),fu.copy(vt.position),fu.add(Ky[mt]),vt.up.copy(Qy[mt]),vt.lookAt(fu),vt.updateMatrixWorld(),Vt.makeTranslation(-xa.x,-xa.y,-xa.z),Pp.multiplyMatrices(vt.projectionMatrix,vt.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Pp,vt.coordinateSystem,vt.reversedDepth)}else z.updateMatrices(O);n=z.getFrustum(),S(C,x,z.camera,O,this.type)}z.isPointLightShadow!==!0&&this.type===sr&&y(z,x),z.needsUpdate=!1}m=this.type,p.needsUpdate=!1,s.setRenderTarget(T,P,R)};function y(E,C){let x=t.update(_);u.defines.VSM_SAMPLES!==E.blurSamples&&(u.defines.VSM_SAMPLES=E.blurSamples,d.defines.VSM_SAMPLES=E.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new gn(i.x,i.y,{format:Ji,type:Qn})),u.uniforms.shadow_pass.value=E.map.depthTexture,u.uniforms.resolution.value=E.mapSize,u.uniforms.radius.value=E.radius,s.setRenderTarget(E.mapPass),s.clear(),s.renderBufferDirect(C,null,x,u,_,null),d.uniforms.shadow_pass.value=E.mapPass.texture,d.uniforms.resolution.value=E.mapSize,d.uniforms.radius.value=E.radius,s.setRenderTarget(E.map),s.clear(),s.renderBufferDirect(C,null,x,d,_,null)}function M(E,C,x,T){let P=null,R=x.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(R!==void 0)P=R;else if(P=x.isPointLight===!0?l:o,s.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let L=P.uuid,B=C.uuid,V=c[L];V===void 0&&(V={},c[L]=V);let N=V[B];N===void 0&&(N=P.clone(),V[B]=N,C.addEventListener("dispose",w)),P=N}if(P.visible=C.visible,P.wireframe=C.wireframe,T===sr?P.side=C.shadowSide!==null?C.shadowSide:C.side:P.side=C.shadowSide!==null?C.shadowSide:f[C.side],P.alphaMap=C.alphaMap,P.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,P.map=C.map,P.clipShadows=C.clipShadows,P.clippingPlanes=C.clippingPlanes,P.clipIntersection=C.clipIntersection,P.displacementMap=C.displacementMap,P.displacementScale=C.displacementScale,P.displacementBias=C.displacementBias,P.wireframeLinewidth=C.wireframeLinewidth,P.linewidth=C.linewidth,x.isPointLight===!0&&P.isMeshDistanceMaterial===!0){let L=s.properties.get(P);L.light=x}return P}function S(E,C,x,T,P){if(E.visible===!1)return;if(E.layers.test(C.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&P===sr)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,E.matrixWorld);let B=t.update(E),V=E.material;if(Array.isArray(V)){let N=B.groups;for(let O=0,z=N.length;O<z;O++){let $=N[O],j=V[$.materialIndex];if(j&&j.visible){let ot=M(E,j,T,P);E.onBeforeShadow(s,E,C,x,B,ot,$),s.renderBufferDirect(x,null,B,ot,E,$),E.onAfterShadow(s,E,C,x,B,ot,$)}}}else if(V.visible){let N=M(E,V,T,P);E.onBeforeShadow(s,E,C,x,B,N,null),s.renderBufferDirect(x,null,B,N,E,null),E.onAfterShadow(s,E,C,x,B,N,null)}}let L=E.children;for(let B=0,V=L.length;B<V;B++)S(L[B],C,x,T,P)}function w(E){E.target.removeEventListener("dispose",w);for(let x in c){let T=c[x],P=E.target.uuid;P in T&&(T[P].dispose(),delete T[P])}}}function tM(s,t){function e(){let D=!1,nt=new Me,q=null,pt=new Me(0,0,0,0);return{setMask:function(rt){q!==rt&&!D&&(s.colorMask(rt,rt,rt,rt),q=rt)},setLocked:function(rt){D=rt},setClear:function(rt,K,Mt,Lt,Se){Se===!0&&(rt*=Lt,K*=Lt,Mt*=Lt),nt.set(rt,K,Mt,Lt),pt.equals(nt)===!1&&(s.clearColor(rt,K,Mt,Lt),pt.copy(nt))},reset:function(){D=!1,q=null,pt.set(-1,0,0,0)}}}function n(){let D=!1,nt=!1,q=null,pt=null,rt=null;return{setReversed:function(K){if(nt!==K){let Mt=t.get("EXT_clip_control");K?Mt.clipControlEXT(Mt.LOWER_LEFT_EXT,Mt.ZERO_TO_ONE_EXT):Mt.clipControlEXT(Mt.LOWER_LEFT_EXT,Mt.NEGATIVE_ONE_TO_ONE_EXT),nt=K;let Lt=rt;rt=null,this.setClear(Lt)}},getReversed:function(){return nt},setTest:function(K){K?it(s.DEPTH_TEST):Ct(s.DEPTH_TEST)},setMask:function(K){q!==K&&!D&&(s.depthMask(K),q=K)},setFunc:function(K){if(nt&&(K=sp[K]),pt!==K){switch(K){case vo:s.depthFunc(s.NEVER);break;case yo:s.depthFunc(s.ALWAYS);break;case Mo:s.depthFunc(s.LESS);break;case ms:s.depthFunc(s.LEQUAL);break;case So:s.depthFunc(s.EQUAL);break;case bo:s.depthFunc(s.GEQUAL);break;case To:s.depthFunc(s.GREATER);break;case Eo:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}pt=K}},setLocked:function(K){D=K},setClear:function(K){rt!==K&&(rt=K,nt&&(K=1-K),s.clearDepth(K))},reset:function(){D=!1,q=null,pt=null,rt=null,nt=!1}}}function i(){let D=!1,nt=null,q=null,pt=null,rt=null,K=null,Mt=null,Lt=null,Se=null;return{setTest:function(Kt){D||(Kt?it(s.STENCIL_TEST):Ct(s.STENCIL_TEST))},setMask:function(Kt){nt!==Kt&&!D&&(s.stencilMask(Kt),nt=Kt)},setFunc:function(Kt,ii,On){(q!==Kt||pt!==ii||rt!==On)&&(s.stencilFunc(Kt,ii,On),q=Kt,pt=ii,rt=On)},setOp:function(Kt,ii,On){(K!==Kt||Mt!==ii||Lt!==On)&&(s.stencilOp(Kt,ii,On),K=Kt,Mt=ii,Lt=On)},setLocked:function(Kt){D=Kt},setClear:function(Kt){Se!==Kt&&(s.clearStencil(Kt),Se=Kt)},reset:function(){D=!1,nt=null,q=null,pt=null,rt=null,K=null,Mt=null,Lt=null,Se=null}}}let r=new e,a=new n,o=new i,l=new WeakMap,c=new WeakMap,h={},f={},u={},d=new WeakMap,g=[],_=null,p=!1,m=null,y=null,M=null,S=null,w=null,E=null,C=null,x=new Yt(0,0,0),T=0,P=!1,R=null,L=null,B=null,V=null,N=null,O=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS),z=!1,$=0,j=s.getParameter(s.VERSION);j.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(j)[1]),z=$>=1):j.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),z=$>=2);let ot=null,mt={},vt=s.getParameter(s.SCISSOR_BOX),Vt=s.getParameter(s.VIEWPORT),Bt=new Me().fromArray(vt),At=new Me().fromArray(Vt);function J(D,nt,q,pt){let rt=new Uint8Array(4),K=s.createTexture();s.bindTexture(D,K),s.texParameteri(D,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(D,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Mt=0;Mt<q;Mt++)D===s.TEXTURE_3D||D===s.TEXTURE_2D_ARRAY?s.texImage3D(nt,0,s.RGBA,1,1,pt,0,s.RGBA,s.UNSIGNED_BYTE,rt):s.texImage2D(nt+Mt,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,rt);return K}let ft={};ft[s.TEXTURE_2D]=J(s.TEXTURE_2D,s.TEXTURE_2D,1),ft[s.TEXTURE_CUBE_MAP]=J(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),ft[s.TEXTURE_2D_ARRAY]=J(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),ft[s.TEXTURE_3D]=J(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),it(s.DEPTH_TEST),a.setFunc(ms),Ae(!1),ue(Nh),it(s.CULL_FACE),ae(Kn);function it(D){h[D]!==!0&&(s.enable(D),h[D]=!0)}function Ct(D){h[D]!==!1&&(s.disable(D),h[D]=!1)}function Dt(D,nt){return u[D]!==nt?(s.bindFramebuffer(D,nt),u[D]=nt,D===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=nt),D===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=nt),!0):!1}function Rt(D,nt){let q=g,pt=!1;if(D){q=d.get(nt),q===void 0&&(q=[],d.set(nt,q));let rt=D.textures;if(q.length!==rt.length||q[0]!==s.COLOR_ATTACHMENT0){for(let K=0,Mt=rt.length;K<Mt;K++)q[K]=s.COLOR_ATTACHMENT0+K;q.length=rt.length,pt=!0}}else q[0]!==s.BACK&&(q[0]=s.BACK,pt=!0);pt&&s.drawBuffers(q)}function he(D){return _!==D?(s.useProgram(D),_=D,!0):!1}let Gt={[ki]:s.FUNC_ADD,[Ad]:s.FUNC_SUBTRACT,[Cd]:s.FUNC_REVERSE_SUBTRACT};Gt[Rd]=s.MIN,Gt[Pd]=s.MAX;let $t={[Id]:s.ZERO,[Dd]:s.ONE,[Ld]:s.SRC_COLOR,[_o]:s.SRC_ALPHA,[zd]:s.SRC_ALPHA_SATURATE,[Od]:s.DST_COLOR,[Ud]:s.DST_ALPHA,[Nd]:s.ONE_MINUS_SRC_COLOR,[xo]:s.ONE_MINUS_SRC_ALPHA,[Bd]:s.ONE_MINUS_DST_COLOR,[Fd]:s.ONE_MINUS_DST_ALPHA,[kd]:s.CONSTANT_COLOR,[Vd]:s.ONE_MINUS_CONSTANT_COLOR,[Gd]:s.CONSTANT_ALPHA,[Hd]:s.ONE_MINUS_CONSTANT_ALPHA};function ae(D,nt,q,pt,rt,K,Mt,Lt,Se,Kt){if(D===Kn){p===!0&&(Ct(s.BLEND),p=!1);return}if(p===!1&&(it(s.BLEND),p=!0),D!==wd){if(D!==m||Kt!==P){if((y!==ki||w!==ki)&&(s.blendEquation(s.FUNC_ADD),y=ki,w=ki),Kt)switch(D){case ps:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Uh:s.blendFunc(s.ONE,s.ONE);break;case Fh:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Oh:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:wt("WebGLState: Invalid blending: ",D);break}else switch(D){case ps:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Uh:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case Fh:wt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Oh:wt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:wt("WebGLState: Invalid blending: ",D);break}M=null,S=null,E=null,C=null,x.set(0,0,0),T=0,m=D,P=Kt}return}rt=rt||nt,K=K||q,Mt=Mt||pt,(nt!==y||rt!==w)&&(s.blendEquationSeparate(Gt[nt],Gt[rt]),y=nt,w=rt),(q!==M||pt!==S||K!==E||Mt!==C)&&(s.blendFuncSeparate($t[q],$t[pt],$t[K],$t[Mt]),M=q,S=pt,E=K,C=Mt),(Lt.equals(x)===!1||Se!==T)&&(s.blendColor(Lt.r,Lt.g,Lt.b,Se),x.copy(Lt),T=Se),m=D,P=!1}function zt(D,nt){D.side===An?Ct(s.CULL_FACE):it(s.CULL_FACE);let q=D.side===ze;nt&&(q=!q),Ae(q),D.blending===ps&&D.transparent===!1?ae(Kn):ae(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);let pt=D.stencilWrite;o.setTest(pt),pt&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),U(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?it(s.SAMPLE_ALPHA_TO_COVERAGE):Ct(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ae(D){R!==D&&(D?s.frontFace(s.CW):s.frontFace(s.CCW),R=D)}function ue(D){D!==bd?(it(s.CULL_FACE),D!==L&&(D===Nh?s.cullFace(s.BACK):D===Td?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Ct(s.CULL_FACE),L=D}function on(D){D!==B&&(z&&s.lineWidth(D),B=D)}function U(D,nt,q){D?(it(s.POLYGON_OFFSET_FILL),(V!==nt||N!==q)&&(V=nt,N=q,a.getReversed()&&(nt=-nt),s.polygonOffset(nt,q))):Ct(s.POLYGON_OFFSET_FILL)}function Ce(D){D?it(s.SCISSOR_TEST):Ct(s.SCISSOR_TEST)}function Ht(D){D===void 0&&(D=s.TEXTURE0+O-1),ot!==D&&(s.activeTexture(D),ot=D)}function se(D,nt,q){q===void 0&&(ot===null?q=s.TEXTURE0+O-1:q=ot);let pt=mt[q];pt===void 0&&(pt={type:void 0,texture:void 0},mt[q]=pt),(pt.type!==D||pt.texture!==nt)&&(ot!==q&&(s.activeTexture(q),ot=q),s.bindTexture(D,nt||ft[D]),pt.type=D,pt.texture=nt)}function lt(){let D=mt[ot];D!==void 0&&D.type!==void 0&&(s.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function ge(){try{s.compressedTexImage2D(...arguments)}catch(D){wt("WebGLState:",D)}}function A(){try{s.compressedTexImage3D(...arguments)}catch(D){wt("WebGLState:",D)}}function v(){try{s.texSubImage2D(...arguments)}catch(D){wt("WebGLState:",D)}}function k(){try{s.texSubImage3D(...arguments)}catch(D){wt("WebGLState:",D)}}function Y(){try{s.compressedTexSubImage2D(...arguments)}catch(D){wt("WebGLState:",D)}}function Q(){try{s.compressedTexSubImage3D(...arguments)}catch(D){wt("WebGLState:",D)}}function tt(){try{s.texStorage2D(...arguments)}catch(D){wt("WebGLState:",D)}}function at(){try{s.texStorage3D(...arguments)}catch(D){wt("WebGLState:",D)}}function X(){try{s.texImage2D(...arguments)}catch(D){wt("WebGLState:",D)}}function Z(){try{s.texImage3D(...arguments)}catch(D){wt("WebGLState:",D)}}function dt(D){return f[D]!==void 0?f[D]:s.getParameter(D)}function _t(D,nt){f[D]!==nt&&(s.pixelStorei(D,nt),f[D]=nt)}function st(D){Bt.equals(D)===!1&&(s.scissor(D.x,D.y,D.z,D.w),Bt.copy(D))}function et(D){At.equals(D)===!1&&(s.viewport(D.x,D.y,D.z,D.w),At.copy(D))}function Pt(D,nt){let q=c.get(nt);q===void 0&&(q=new WeakMap,c.set(nt,q));let pt=q.get(D);pt===void 0&&(pt=s.getUniformBlockIndex(nt,D.name),q.set(D,pt))}function Ut(D,nt){let pt=c.get(nt).get(D);l.get(nt)!==pt&&(s.uniformBlockBinding(nt,pt,D.__bindingPointIndex),l.set(nt,pt))}function Zt(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),s.pixelStorei(s.PACK_ALIGNMENT,4),s.pixelStorei(s.UNPACK_ALIGNMENT,4),s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,!1),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,s.BROWSER_DEFAULT_WEBGL),s.pixelStorei(s.PACK_ROW_LENGTH,0),s.pixelStorei(s.PACK_SKIP_PIXELS,0),s.pixelStorei(s.PACK_SKIP_ROWS,0),s.pixelStorei(s.UNPACK_ROW_LENGTH,0),s.pixelStorei(s.UNPACK_IMAGE_HEIGHT,0),s.pixelStorei(s.UNPACK_SKIP_PIXELS,0),s.pixelStorei(s.UNPACK_SKIP_ROWS,0),s.pixelStorei(s.UNPACK_SKIP_IMAGES,0),h={},f={},ot=null,mt={},u={},d=new WeakMap,g=[],_=null,p=!1,m=null,y=null,M=null,S=null,w=null,E=null,C=null,x=new Yt(0,0,0),T=0,P=!1,R=null,L=null,B=null,V=null,N=null,Bt.set(0,0,s.canvas.width,s.canvas.height),At.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:it,disable:Ct,bindFramebuffer:Dt,drawBuffers:Rt,useProgram:he,setBlending:ae,setMaterial:zt,setFlipSided:Ae,setCullFace:ue,setLineWidth:on,setPolygonOffset:U,setScissorTest:Ce,activeTexture:Ht,bindTexture:se,unbindTexture:lt,compressedTexImage2D:ge,compressedTexImage3D:A,texImage2D:X,texImage3D:Z,pixelStorei:_t,getParameter:dt,updateUBOMapping:Pt,uniformBlockBinding:Ut,texStorage2D:tt,texStorage3D:at,texSubImage2D:v,texSubImage3D:k,compressedTexSubImage2D:Y,compressedTexSubImage3D:Q,scissor:st,viewport:et,reset:Zt}}function eM(s,t,e,n,i,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Tt,h=new WeakMap,f=new Set,u,d=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(A,v){return g?new OffscreenCanvas(A,v):$s("canvas")}function p(A,v,k){let Y=1,Q=ge(A);if((Q.width>k||Q.height>k)&&(Y=k/Math.max(Q.width,Q.height)),Y<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){let tt=Math.floor(Y*Q.width),at=Math.floor(Y*Q.height);u===void 0&&(u=_(tt,at));let X=v?_(tt,at):u;return X.width=tt,X.height=at,X.getContext("2d").drawImage(A,0,0,tt,at),Et("WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+tt+"x"+at+")."),X}else return"data"in A&&Et("WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),A;return A}function m(A){return A.generateMipmaps}function y(A){s.generateMipmap(A)}function M(A){return A.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?s.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function S(A,v,k,Y,Q,tt=!1){if(A!==null){if(s[A]!==void 0)return s[A];Et("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let at;Y&&(at=t.get("EXT_texture_norm16"),at||Et("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let X=v;if(v===s.RED&&(k===s.FLOAT&&(X=s.R32F),k===s.HALF_FLOAT&&(X=s.R16F),k===s.UNSIGNED_BYTE&&(X=s.R8),k===s.UNSIGNED_SHORT&&at&&(X=at.R16_EXT),k===s.SHORT&&at&&(X=at.R16_SNORM_EXT)),v===s.RED_INTEGER&&(k===s.UNSIGNED_BYTE&&(X=s.R8UI),k===s.UNSIGNED_SHORT&&(X=s.R16UI),k===s.UNSIGNED_INT&&(X=s.R32UI),k===s.BYTE&&(X=s.R8I),k===s.SHORT&&(X=s.R16I),k===s.INT&&(X=s.R32I)),v===s.RG&&(k===s.FLOAT&&(X=s.RG32F),k===s.HALF_FLOAT&&(X=s.RG16F),k===s.UNSIGNED_BYTE&&(X=s.RG8),k===s.UNSIGNED_SHORT&&at&&(X=at.RG16_EXT),k===s.SHORT&&at&&(X=at.RG16_SNORM_EXT)),v===s.RG_INTEGER&&(k===s.UNSIGNED_BYTE&&(X=s.RG8UI),k===s.UNSIGNED_SHORT&&(X=s.RG16UI),k===s.UNSIGNED_INT&&(X=s.RG32UI),k===s.BYTE&&(X=s.RG8I),k===s.SHORT&&(X=s.RG16I),k===s.INT&&(X=s.RG32I)),v===s.RGB_INTEGER&&(k===s.UNSIGNED_BYTE&&(X=s.RGB8UI),k===s.UNSIGNED_SHORT&&(X=s.RGB16UI),k===s.UNSIGNED_INT&&(X=s.RGB32UI),k===s.BYTE&&(X=s.RGB8I),k===s.SHORT&&(X=s.RGB16I),k===s.INT&&(X=s.RGB32I)),v===s.RGBA_INTEGER&&(k===s.UNSIGNED_BYTE&&(X=s.RGBA8UI),k===s.UNSIGNED_SHORT&&(X=s.RGBA16UI),k===s.UNSIGNED_INT&&(X=s.RGBA32UI),k===s.BYTE&&(X=s.RGBA8I),k===s.SHORT&&(X=s.RGBA16I),k===s.INT&&(X=s.RGBA32I)),v===s.RGB&&(k===s.UNSIGNED_SHORT&&at&&(X=at.RGB16_EXT),k===s.SHORT&&at&&(X=at.RGB16_SNORM_EXT),k===s.UNSIGNED_INT_5_9_9_9_REV&&(X=s.RGB9_E5),k===s.UNSIGNED_INT_10F_11F_11F_REV&&(X=s.R11F_G11F_B10F)),v===s.RGBA){let Z=tt?Or:Wt.getTransfer(Q);k===s.FLOAT&&(X=s.RGBA32F),k===s.HALF_FLOAT&&(X=s.RGBA16F),k===s.UNSIGNED_BYTE&&(X=Z===Jt?s.SRGB8_ALPHA8:s.RGBA8),k===s.UNSIGNED_SHORT&&at&&(X=at.RGBA16_EXT),k===s.SHORT&&at&&(X=at.RGBA16_SNORM_EXT),k===s.UNSIGNED_SHORT_4_4_4_4&&(X=s.RGBA4),k===s.UNSIGNED_SHORT_5_5_5_1&&(X=s.RGB5_A1)}return(X===s.R16F||X===s.R32F||X===s.RG16F||X===s.RG32F||X===s.RGBA16F||X===s.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function w(A,v){let k;return A?v===null||v===Un||v===ar?k=s.DEPTH24_STENCIL8:v===Fn?k=s.DEPTH32F_STENCIL8:v===rr&&(k=s.DEPTH24_STENCIL8,Et("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Un||v===ar?k=s.DEPTH_COMPONENT24:v===Fn?k=s.DEPTH_COMPONENT32F:v===rr&&(k=s.DEPTH_COMPONENT16),k}function E(A,v){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==Le&&A.minFilter!==Oe?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function C(A){let v=A.target;v.removeEventListener("dispose",C),T(v),v.isVideoTexture&&h.delete(v),v.isHTMLTexture&&f.delete(v)}function x(A){let v=A.target;v.removeEventListener("dispose",x),R(v)}function T(A){let v=n.get(A);if(v.__webglInit===void 0)return;let k=A.source,Y=d.get(k);if(Y){let Q=Y[v.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&P(A),Object.keys(Y).length===0&&d.delete(k)}n.remove(A)}function P(A){let v=n.get(A);s.deleteTexture(v.__webglTexture);let k=A.source,Y=d.get(k);delete Y[v.__cacheKey],a.memory.textures--}function R(A){let v=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(v.__webglFramebuffer[Y]))for(let Q=0;Q<v.__webglFramebuffer[Y].length;Q++)s.deleteFramebuffer(v.__webglFramebuffer[Y][Q]);else s.deleteFramebuffer(v.__webglFramebuffer[Y]);v.__webglDepthbuffer&&s.deleteRenderbuffer(v.__webglDepthbuffer[Y])}else{if(Array.isArray(v.__webglFramebuffer))for(let Y=0;Y<v.__webglFramebuffer.length;Y++)s.deleteFramebuffer(v.__webglFramebuffer[Y]);else s.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&s.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&s.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Y=0;Y<v.__webglColorRenderbuffer.length;Y++)v.__webglColorRenderbuffer[Y]&&s.deleteRenderbuffer(v.__webglColorRenderbuffer[Y]);v.__webglDepthRenderbuffer&&s.deleteRenderbuffer(v.__webglDepthRenderbuffer)}let k=A.textures;for(let Y=0,Q=k.length;Y<Q;Y++){let tt=n.get(k[Y]);tt.__webglTexture&&(s.deleteTexture(tt.__webglTexture),a.memory.textures--),n.remove(k[Y])}n.remove(A)}let L=0;function B(){L=0}function V(){return L}function N(A){L=A}function O(){let A=L;return A>=i.maxTextures&&Et("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+i.maxTextures),L+=1,A}function z(A){let v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function $(A,v){let k=n.get(A);if(A.isVideoTexture&&se(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&k.__version!==A.version){let Y=A.image;if(Y===null)Et("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Et("WebGLRenderer: Texture marked for update but image is incomplete");else{Ct(k,A,v);return}}else A.isExternalTexture&&(k.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(s.TEXTURE_2D,k.__webglTexture,s.TEXTURE0+v)}function j(A,v){let k=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&k.__version!==A.version){Ct(k,A,v);return}else A.isExternalTexture&&(k.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(s.TEXTURE_2D_ARRAY,k.__webglTexture,s.TEXTURE0+v)}function ot(A,v){let k=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&k.__version!==A.version){Ct(k,A,v);return}e.bindTexture(s.TEXTURE_3D,k.__webglTexture,s.TEXTURE0+v)}function mt(A,v){let k=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&k.__version!==A.version){Dt(k,A,v);return}e.bindTexture(s.TEXTURE_CUBE_MAP,k.__webglTexture,s.TEXTURE0+v)}let vt={[wo]:s.REPEAT,[qn]:s.CLAMP_TO_EDGE,[Ao]:s.MIRRORED_REPEAT},Vt={[Le]:s.NEAREST,[qd]:s.NEAREST_MIPMAP_NEAREST,[ha]:s.NEAREST_MIPMAP_LINEAR,[Oe]:s.LINEAR,[ul]:s.LINEAR_MIPMAP_NEAREST,[Yi]:s.LINEAR_MIPMAP_LINEAR},Bt={[Jd]:s.NEVER,[tp]:s.ALWAYS,[$d]:s.LESS,[Zl]:s.LEQUAL,[Kd]:s.EQUAL,[Jl]:s.GEQUAL,[Qd]:s.GREATER,[jd]:s.NOTEQUAL};function At(A,v){if(v.type===Fn&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===Oe||v.magFilter===ul||v.magFilter===ha||v.magFilter===Yi||v.minFilter===Oe||v.minFilter===ul||v.minFilter===ha||v.minFilter===Yi)&&Et("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(A,s.TEXTURE_WRAP_S,vt[v.wrapS]),s.texParameteri(A,s.TEXTURE_WRAP_T,vt[v.wrapT]),(A===s.TEXTURE_3D||A===s.TEXTURE_2D_ARRAY)&&s.texParameteri(A,s.TEXTURE_WRAP_R,vt[v.wrapR]),s.texParameteri(A,s.TEXTURE_MAG_FILTER,Vt[v.magFilter]),s.texParameteri(A,s.TEXTURE_MIN_FILTER,Vt[v.minFilter]),v.compareFunction&&(s.texParameteri(A,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(A,s.TEXTURE_COMPARE_FUNC,Bt[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Le||v.minFilter!==ha&&v.minFilter!==Yi||v.type===Fn&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){let k=t.get("EXT_texture_filter_anisotropic");s.texParameterf(A,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,i.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function J(A,v){let k=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",C));let Y=v.source,Q=d.get(Y);Q===void 0&&(Q={},d.set(Y,Q));let tt=z(v);if(tt!==A.__cacheKey){Q[tt]===void 0&&(Q[tt]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,k=!0),Q[tt].usedTimes++;let at=Q[A.__cacheKey];at!==void 0&&(Q[A.__cacheKey].usedTimes--,at.usedTimes===0&&P(v)),A.__cacheKey=tt,A.__webglTexture=Q[tt].texture}return k}function ft(A,v,k){return Math.floor(Math.floor(A/k)/v)}function it(A,v,k,Y){let tt=A.updateRanges;if(tt.length===0)e.texSubImage2D(s.TEXTURE_2D,0,0,0,v.width,v.height,k,Y,v.data);else{tt.sort((_t,st)=>_t.start-st.start);let at=0;for(let _t=1;_t<tt.length;_t++){let st=tt[at],et=tt[_t],Pt=st.start+st.count,Ut=ft(et.start,v.width,4),Zt=ft(st.start,v.width,4);et.start<=Pt+1&&Ut===Zt&&ft(et.start+et.count-1,v.width,4)===Ut?st.count=Math.max(st.count,et.start+et.count-st.start):(++at,tt[at]=et)}tt.length=at+1;let X=e.getParameter(s.UNPACK_ROW_LENGTH),Z=e.getParameter(s.UNPACK_SKIP_PIXELS),dt=e.getParameter(s.UNPACK_SKIP_ROWS);e.pixelStorei(s.UNPACK_ROW_LENGTH,v.width);for(let _t=0,st=tt.length;_t<st;_t++){let et=tt[_t],Pt=Math.floor(et.start/4),Ut=Math.ceil(et.count/4),Zt=Pt%v.width,D=Math.floor(Pt/v.width),nt=Ut,q=1;e.pixelStorei(s.UNPACK_SKIP_PIXELS,Zt),e.pixelStorei(s.UNPACK_SKIP_ROWS,D),e.texSubImage2D(s.TEXTURE_2D,0,Zt,D,nt,q,k,Y,v.data)}A.clearUpdateRanges(),e.pixelStorei(s.UNPACK_ROW_LENGTH,X),e.pixelStorei(s.UNPACK_SKIP_PIXELS,Z),e.pixelStorei(s.UNPACK_SKIP_ROWS,dt)}}function Ct(A,v,k){let Y=s.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Y=s.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Y=s.TEXTURE_3D);let Q=J(A,v),tt=v.source;e.bindTexture(Y,A.__webglTexture,s.TEXTURE0+k);let at=n.get(tt);if(tt.version!==at.__version||Q===!0){if(e.activeTexture(s.TEXTURE0+k),(typeof ImageBitmap<"u"&&v.image instanceof ImageBitmap)===!1){let q=Wt.getPrimaries(Wt.workingColorSpace),pt=v.colorSpace===yi?null:Wt.getPrimaries(v.colorSpace),rt=v.colorSpace===yi||q===pt?s.NONE:s.BROWSER_DEFAULT_WEBGL;e.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,v.flipY),e.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),e.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,rt)}e.pixelStorei(s.UNPACK_ALIGNMENT,v.unpackAlignment);let Z=p(v.image,!1,i.maxTextureSize);Z=lt(v,Z);let dt=r.convert(v.format,v.colorSpace),_t=r.convert(v.type),st=S(v.internalFormat,dt,_t,v.normalized,v.colorSpace,v.isVideoTexture);At(Y,v);let et,Pt=v.mipmaps,Ut=v.isVideoTexture!==!0,Zt=at.__version===void 0||Q===!0,D=tt.dataReady,nt=E(v,Z);if(v.isDepthTexture)st=w(v.format===Zi,v.type),Zt&&(Ut?e.texStorage2D(s.TEXTURE_2D,1,st,Z.width,Z.height):e.texImage2D(s.TEXTURE_2D,0,st,Z.width,Z.height,0,dt,_t,null));else if(v.isDataTexture)if(Pt.length>0){Ut&&Zt&&e.texStorage2D(s.TEXTURE_2D,nt,st,Pt[0].width,Pt[0].height);for(let q=0,pt=Pt.length;q<pt;q++)et=Pt[q],Ut?D&&e.texSubImage2D(s.TEXTURE_2D,q,0,0,et.width,et.height,dt,_t,et.data):e.texImage2D(s.TEXTURE_2D,q,st,et.width,et.height,0,dt,_t,et.data);v.generateMipmaps=!1}else Ut?(Zt&&e.texStorage2D(s.TEXTURE_2D,nt,st,Z.width,Z.height),D&&it(v,Z,dt,_t)):e.texImage2D(s.TEXTURE_2D,0,st,Z.width,Z.height,0,dt,_t,Z.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Ut&&Zt&&e.texStorage3D(s.TEXTURE_2D_ARRAY,nt,st,Pt[0].width,Pt[0].height,Z.depth);for(let q=0,pt=Pt.length;q<pt;q++)if(et=Pt[q],v.format!==Cn)if(dt!==null)if(Ut){if(D)if(v.layerUpdates.size>0){let rt=au(et.width,et.height,v.format,v.type);for(let K of v.layerUpdates){let Mt=et.data.subarray(K*rt/et.data.BYTES_PER_ELEMENT,(K+1)*rt/et.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,q,0,0,K,et.width,et.height,1,dt,Mt)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,q,0,0,0,et.width,et.height,Z.depth,dt,et.data)}else e.compressedTexImage3D(s.TEXTURE_2D_ARRAY,q,st,et.width,et.height,Z.depth,0,et.data,0,0);else Et("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ut?D&&e.texSubImage3D(s.TEXTURE_2D_ARRAY,q,0,0,0,et.width,et.height,Z.depth,dt,_t,et.data):e.texImage3D(s.TEXTURE_2D_ARRAY,q,st,et.width,et.height,Z.depth,0,dt,_t,et.data)}else{Ut&&Zt&&e.texStorage2D(s.TEXTURE_2D,nt,st,Pt[0].width,Pt[0].height);for(let q=0,pt=Pt.length;q<pt;q++)et=Pt[q],v.format!==Cn?dt!==null?Ut?D&&e.compressedTexSubImage2D(s.TEXTURE_2D,q,0,0,et.width,et.height,dt,et.data):e.compressedTexImage2D(s.TEXTURE_2D,q,st,et.width,et.height,0,et.data):Et("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ut?D&&e.texSubImage2D(s.TEXTURE_2D,q,0,0,et.width,et.height,dt,_t,et.data):e.texImage2D(s.TEXTURE_2D,q,st,et.width,et.height,0,dt,_t,et.data)}else if(v.isDataArrayTexture)if(Ut){if(Zt&&e.texStorage3D(s.TEXTURE_2D_ARRAY,nt,st,Z.width,Z.height,Z.depth),D)if(v.layerUpdates.size>0){let q=au(Z.width,Z.height,v.format,v.type);for(let pt of v.layerUpdates){let rt=Z.data.subarray(pt*q/Z.data.BYTES_PER_ELEMENT,(pt+1)*q/Z.data.BYTES_PER_ELEMENT);e.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,pt,Z.width,Z.height,1,dt,_t,rt)}v.clearLayerUpdates()}else e.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,Z.width,Z.height,Z.depth,dt,_t,Z.data)}else e.texImage3D(s.TEXTURE_2D_ARRAY,0,st,Z.width,Z.height,Z.depth,0,dt,_t,Z.data);else if(v.isData3DTexture)Ut?(Zt&&e.texStorage3D(s.TEXTURE_3D,nt,st,Z.width,Z.height,Z.depth),D&&e.texSubImage3D(s.TEXTURE_3D,0,0,0,0,Z.width,Z.height,Z.depth,dt,_t,Z.data)):e.texImage3D(s.TEXTURE_3D,0,st,Z.width,Z.height,Z.depth,0,dt,_t,Z.data);else if(v.isFramebufferTexture){if(Zt)if(Ut)e.texStorage2D(s.TEXTURE_2D,nt,st,Z.width,Z.height);else{let q=Z.width,pt=Z.height;for(let rt=0;rt<nt;rt++)e.texImage2D(s.TEXTURE_2D,rt,st,q,pt,0,dt,_t,null),q>>=1,pt>>=1}}else if(v.isHTMLTexture){if("texElementImage2D"in s){let q=s.canvas;if(q.hasAttribute("layoutsubtree")||q.setAttribute("layoutsubtree","true"),Z.parentNode!==q){q.appendChild(Z),f.add(v),q.onpaint=Lt=>{let Se=Lt.changedElements;for(let Kt of f)Se.includes(Kt.image)&&(Kt.needsUpdate=!0)},q.requestPaint();return}let pt=0,rt=s.RGBA,K=s.RGBA,Mt=s.UNSIGNED_BYTE;s.texElementImage2D(s.TEXTURE_2D,pt,rt,K,Mt,Z),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.CLAMP_TO_EDGE),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.CLAMP_TO_EDGE)}}else if(Pt.length>0){if(Ut&&Zt){let q=ge(Pt[0]);e.texStorage2D(s.TEXTURE_2D,nt,st,q.width,q.height)}for(let q=0,pt=Pt.length;q<pt;q++)et=Pt[q],Ut?D&&e.texSubImage2D(s.TEXTURE_2D,q,0,0,dt,_t,et):e.texImage2D(s.TEXTURE_2D,q,st,dt,_t,et);v.generateMipmaps=!1}else if(Ut){if(Zt){let q=ge(Z);e.texStorage2D(s.TEXTURE_2D,nt,st,q.width,q.height)}D&&e.texSubImage2D(s.TEXTURE_2D,0,0,0,dt,_t,Z)}else e.texImage2D(s.TEXTURE_2D,0,st,dt,_t,Z);m(v)&&y(Y),at.__version=tt.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function Dt(A,v,k){if(v.image.length!==6)return;let Y=J(A,v),Q=v.source;e.bindTexture(s.TEXTURE_CUBE_MAP,A.__webglTexture,s.TEXTURE0+k);let tt=n.get(Q);if(Q.version!==tt.__version||Y===!0){e.activeTexture(s.TEXTURE0+k);let at=Wt.getPrimaries(Wt.workingColorSpace),X=v.colorSpace===yi?null:Wt.getPrimaries(v.colorSpace),Z=v.colorSpace===yi||at===X?s.NONE:s.BROWSER_DEFAULT_WEBGL;e.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,v.flipY),e.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),e.pixelStorei(s.UNPACK_ALIGNMENT,v.unpackAlignment),e.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Z);let dt=v.isCompressedTexture||v.image[0].isCompressedTexture,_t=v.image[0]&&v.image[0].isDataTexture,st=[];for(let K=0;K<6;K++)!dt&&!_t?st[K]=p(v.image[K],!0,i.maxCubemapSize):st[K]=_t?v.image[K].image:v.image[K],st[K]=lt(v,st[K]);let et=st[0],Pt=r.convert(v.format,v.colorSpace),Ut=r.convert(v.type),Zt=S(v.internalFormat,Pt,Ut,v.normalized,v.colorSpace),D=v.isVideoTexture!==!0,nt=tt.__version===void 0||Y===!0,q=Q.dataReady,pt=E(v,et);At(s.TEXTURE_CUBE_MAP,v);let rt;if(dt){D&&nt&&e.texStorage2D(s.TEXTURE_CUBE_MAP,pt,Zt,et.width,et.height);for(let K=0;K<6;K++){rt=st[K].mipmaps;for(let Mt=0;Mt<rt.length;Mt++){let Lt=rt[Mt];v.format!==Cn?Pt!==null?D?q&&e.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Mt,0,0,Lt.width,Lt.height,Pt,Lt.data):e.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Mt,Zt,Lt.width,Lt.height,0,Lt.data):Et("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?q&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Mt,0,0,Lt.width,Lt.height,Pt,Ut,Lt.data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Mt,Zt,Lt.width,Lt.height,0,Pt,Ut,Lt.data)}}}else{if(rt=v.mipmaps,D&&nt){rt.length>0&&pt++;let K=ge(st[0]);e.texStorage2D(s.TEXTURE_CUBE_MAP,pt,Zt,K.width,K.height)}for(let K=0;K<6;K++)if(_t){D?q&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,st[K].width,st[K].height,Pt,Ut,st[K].data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Zt,st[K].width,st[K].height,0,Pt,Ut,st[K].data);for(let Mt=0;Mt<rt.length;Mt++){let Se=rt[Mt].image[K].image;D?q&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Mt+1,0,0,Se.width,Se.height,Pt,Ut,Se.data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Mt+1,Zt,Se.width,Se.height,0,Pt,Ut,Se.data)}}else{D?q&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Pt,Ut,st[K]):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Zt,Pt,Ut,st[K]);for(let Mt=0;Mt<rt.length;Mt++){let Lt=rt[Mt];D?q&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Mt+1,0,0,Pt,Ut,Lt.image[K]):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,Mt+1,Zt,Pt,Ut,Lt.image[K])}}}m(v)&&y(s.TEXTURE_CUBE_MAP),tt.__version=Q.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function Rt(A,v,k,Y,Q,tt){let at=r.convert(k.format,k.colorSpace),X=r.convert(k.type),Z=S(k.internalFormat,at,X,k.normalized,k.colorSpace),dt=n.get(v),_t=n.get(k);if(_t.__renderTarget=v,!dt.__hasExternalTextures){let st=Math.max(1,v.width>>tt),et=Math.max(1,v.height>>tt);Q===s.TEXTURE_3D||Q===s.TEXTURE_2D_ARRAY?e.texImage3D(Q,tt,Z,st,et,v.depth,0,at,X,null):e.texImage2D(Q,tt,Z,st,et,0,at,X,null)}e.bindFramebuffer(s.FRAMEBUFFER,A),Ht(v)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Y,Q,_t.__webglTexture,0,Ce(v)):(Q===s.TEXTURE_2D||Q>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,Y,Q,_t.__webglTexture,tt),e.bindFramebuffer(s.FRAMEBUFFER,null)}function he(A,v,k){if(s.bindRenderbuffer(s.RENDERBUFFER,A),v.depthBuffer){let Y=v.depthTexture,Q=Y&&Y.isDepthTexture?Y.type:null,tt=w(v.stencilBuffer,Q),at=v.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;Ht(v)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ce(v),tt,v.width,v.height):k?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ce(v),tt,v.width,v.height):s.renderbufferStorage(s.RENDERBUFFER,tt,v.width,v.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,at,s.RENDERBUFFER,A)}else{let Y=v.textures;for(let Q=0;Q<Y.length;Q++){let tt=Y[Q],at=r.convert(tt.format,tt.colorSpace),X=r.convert(tt.type),Z=S(tt.internalFormat,at,X,tt.normalized,tt.colorSpace);Ht(v)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ce(v),Z,v.width,v.height):k?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ce(v),Z,v.width,v.height):s.renderbufferStorage(s.RENDERBUFFER,Z,v.width,v.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Gt(A,v,k){let Y=v.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(s.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let Q=n.get(v.depthTexture);if(Q.__renderTarget=v,(!Q.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Y){if(Q.__webglInit===void 0&&(Q.__webglInit=!0,v.depthTexture.addEventListener("dispose",C)),Q.__webglTexture===void 0){Q.__webglTexture=s.createTexture(),e.bindTexture(s.TEXTURE_CUBE_MAP,Q.__webglTexture),At(s.TEXTURE_CUBE_MAP,v.depthTexture);let dt=r.convert(v.depthTexture.format),_t=r.convert(v.depthTexture.type),st;v.depthTexture.format===Zn?st=s.DEPTH_COMPONENT24:v.depthTexture.format===Zi&&(st=s.DEPTH24_STENCIL8);for(let et=0;et<6;et++)s.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,st,v.width,v.height,0,dt,_t,null)}}else $(v.depthTexture,0);let tt=Q.__webglTexture,at=Ce(v),X=Y?s.TEXTURE_CUBE_MAP_POSITIVE_X+k:s.TEXTURE_2D,Z=v.depthTexture.format===Zi?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;if(v.depthTexture.format===Zn)Ht(v)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Z,X,tt,0,at):s.framebufferTexture2D(s.FRAMEBUFFER,Z,X,tt,0);else if(v.depthTexture.format===Zi)Ht(v)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Z,X,tt,0,at):s.framebufferTexture2D(s.FRAMEBUFFER,Z,X,tt,0);else throw new Error("Unknown depthTexture format")}function $t(A){let v=n.get(A),k=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){let Y=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Y){let Q=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Y.removeEventListener("dispose",Q)};Y.addEventListener("dispose",Q),v.__depthDisposeCallback=Q}v.__boundDepthTexture=Y}if(A.depthTexture&&!v.__autoAllocateDepthBuffer)if(k)for(let Y=0;Y<6;Y++)Gt(v.__webglFramebuffer[Y],A,Y);else{let Y=A.texture.mipmaps;Y&&Y.length>0?Gt(v.__webglFramebuffer[0],A,0):Gt(v.__webglFramebuffer,A,0)}else if(k){v.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(e.bindFramebuffer(s.FRAMEBUFFER,v.__webglFramebuffer[Y]),v.__webglDepthbuffer[Y]===void 0)v.__webglDepthbuffer[Y]=s.createRenderbuffer(),he(v.__webglDepthbuffer[Y],A,!1);else{let Q=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,tt=v.__webglDepthbuffer[Y];s.bindRenderbuffer(s.RENDERBUFFER,tt),s.framebufferRenderbuffer(s.FRAMEBUFFER,Q,s.RENDERBUFFER,tt)}}else{let Y=A.texture.mipmaps;if(Y&&Y.length>0?e.bindFramebuffer(s.FRAMEBUFFER,v.__webglFramebuffer[0]):e.bindFramebuffer(s.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=s.createRenderbuffer(),he(v.__webglDepthbuffer,A,!1);else{let Q=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,tt=v.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,tt),s.framebufferRenderbuffer(s.FRAMEBUFFER,Q,s.RENDERBUFFER,tt)}}e.bindFramebuffer(s.FRAMEBUFFER,null)}function ae(A,v,k){let Y=n.get(A);v!==void 0&&Rt(Y.__webglFramebuffer,A,A.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),k!==void 0&&$t(A)}function zt(A){let v=A.texture,k=n.get(A),Y=n.get(v);A.addEventListener("dispose",x);let Q=A.textures,tt=A.isWebGLCubeRenderTarget===!0,at=Q.length>1;if(at||(Y.__webglTexture===void 0&&(Y.__webglTexture=s.createTexture()),Y.__version=v.version,a.memory.textures++),tt){k.__webglFramebuffer=[];for(let X=0;X<6;X++)if(v.mipmaps&&v.mipmaps.length>0){k.__webglFramebuffer[X]=[];for(let Z=0;Z<v.mipmaps.length;Z++)k.__webglFramebuffer[X][Z]=s.createFramebuffer()}else k.__webglFramebuffer[X]=s.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){k.__webglFramebuffer=[];for(let X=0;X<v.mipmaps.length;X++)k.__webglFramebuffer[X]=s.createFramebuffer()}else k.__webglFramebuffer=s.createFramebuffer();if(at)for(let X=0,Z=Q.length;X<Z;X++){let dt=n.get(Q[X]);dt.__webglTexture===void 0&&(dt.__webglTexture=s.createTexture(),a.memory.textures++)}if(A.samples>0&&Ht(A)===!1){k.__webglMultisampledFramebuffer=s.createFramebuffer(),k.__webglColorRenderbuffer=[],e.bindFramebuffer(s.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let X=0;X<Q.length;X++){let Z=Q[X];k.__webglColorRenderbuffer[X]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,k.__webglColorRenderbuffer[X]);let dt=r.convert(Z.format,Z.colorSpace),_t=r.convert(Z.type),st=S(Z.internalFormat,dt,_t,Z.normalized,Z.colorSpace,A.isXRRenderTarget===!0),et=Ce(A);s.renderbufferStorageMultisample(s.RENDERBUFFER,et,st,A.width,A.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+X,s.RENDERBUFFER,k.__webglColorRenderbuffer[X])}s.bindRenderbuffer(s.RENDERBUFFER,null),A.depthBuffer&&(k.__webglDepthRenderbuffer=s.createRenderbuffer(),he(k.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(s.FRAMEBUFFER,null)}}if(tt){e.bindTexture(s.TEXTURE_CUBE_MAP,Y.__webglTexture),At(s.TEXTURE_CUBE_MAP,v);for(let X=0;X<6;X++)if(v.mipmaps&&v.mipmaps.length>0)for(let Z=0;Z<v.mipmaps.length;Z++)Rt(k.__webglFramebuffer[X][Z],A,v,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+X,Z);else Rt(k.__webglFramebuffer[X],A,v,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+X,0);m(v)&&y(s.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(at){for(let X=0,Z=Q.length;X<Z;X++){let dt=Q[X],_t=n.get(dt),st=s.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(st=A.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),e.bindTexture(st,_t.__webglTexture),At(st,dt),Rt(k.__webglFramebuffer,A,dt,s.COLOR_ATTACHMENT0+X,st,0),m(dt)&&y(st)}e.unbindTexture()}else{let X=s.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(X=A.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),e.bindTexture(X,Y.__webglTexture),At(X,v),v.mipmaps&&v.mipmaps.length>0)for(let Z=0;Z<v.mipmaps.length;Z++)Rt(k.__webglFramebuffer[Z],A,v,s.COLOR_ATTACHMENT0,X,Z);else Rt(k.__webglFramebuffer,A,v,s.COLOR_ATTACHMENT0,X,0);m(v)&&y(X),e.unbindTexture()}A.depthBuffer&&$t(A)}function Ae(A){let v=A.textures;for(let k=0,Y=v.length;k<Y;k++){let Q=v[k];if(m(Q)){let tt=M(A),at=n.get(Q).__webglTexture;e.bindTexture(tt,at),y(tt),e.unbindTexture()}}}let ue=[],on=[];function U(A){if(A.samples>0){if(Ht(A)===!1){let v=A.textures,k=A.width,Y=A.height,Q=s.COLOR_BUFFER_BIT,tt=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,at=n.get(A),X=v.length>1;if(X)for(let dt=0;dt<v.length;dt++)e.bindFramebuffer(s.FRAMEBUFFER,at.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+dt,s.RENDERBUFFER,null),e.bindFramebuffer(s.FRAMEBUFFER,at.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+dt,s.TEXTURE_2D,null,0);e.bindFramebuffer(s.READ_FRAMEBUFFER,at.__webglMultisampledFramebuffer);let Z=A.texture.mipmaps;Z&&Z.length>0?e.bindFramebuffer(s.DRAW_FRAMEBUFFER,at.__webglFramebuffer[0]):e.bindFramebuffer(s.DRAW_FRAMEBUFFER,at.__webglFramebuffer);for(let dt=0;dt<v.length;dt++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(Q|=s.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(Q|=s.STENCIL_BUFFER_BIT)),X){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,at.__webglColorRenderbuffer[dt]);let _t=n.get(v[dt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,_t,0)}s.blitFramebuffer(0,0,k,Y,0,0,k,Y,Q,s.NEAREST),l===!0&&(ue.length=0,on.length=0,ue.push(s.COLOR_ATTACHMENT0+dt),A.depthBuffer&&A.resolveDepthBuffer===!1&&(ue.push(tt),on.push(tt),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,on)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,ue))}if(e.bindFramebuffer(s.READ_FRAMEBUFFER,null),e.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),X)for(let dt=0;dt<v.length;dt++){e.bindFramebuffer(s.FRAMEBUFFER,at.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+dt,s.RENDERBUFFER,at.__webglColorRenderbuffer[dt]);let _t=n.get(v[dt]).__webglTexture;e.bindFramebuffer(s.FRAMEBUFFER,at.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+dt,s.TEXTURE_2D,_t,0)}e.bindFramebuffer(s.DRAW_FRAMEBUFFER,at.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){let v=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[v])}}}function Ce(A){return Math.min(i.maxSamples,A.samples)}function Ht(A){let v=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function se(A){let v=a.render.frame;h.get(A)!==v&&(h.set(A,v),A.update())}function lt(A,v){let k=A.colorSpace,Y=A.format,Q=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||k!==Fr&&k!==yi&&(Wt.getTransfer(k)===Jt?(Y!==Cn||Q!==vn)&&Et("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):wt("WebGLTextures: Unsupported texture color space:",k)),v}function ge(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=B,this.getTextureUnits=V,this.setTextureUnits=N,this.setTexture2D=$,this.setTexture2DArray=j,this.setTexture3D=ot,this.setTextureCube=mt,this.rebindTextures=ae,this.setupRenderTarget=zt,this.updateRenderTargetMipmap=Ae,this.updateMultisampleRenderTarget=U,this.setupDepthRenderbuffer=$t,this.setupFrameBufferTexture=Rt,this.useMultisampledRTT=Ht,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function nM(s,t){function e(n,i=yi){let r,a=Wt.getTransfer(i);if(n===vn)return s.UNSIGNED_BYTE;if(n===dl)return s.UNSIGNED_SHORT_4_4_4_4;if(n===pl)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Jh)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===$h)return s.UNSIGNED_INT_10F_11F_11F_REV;if(n===Yh)return s.BYTE;if(n===Zh)return s.SHORT;if(n===rr)return s.UNSIGNED_SHORT;if(n===fl)return s.INT;if(n===Un)return s.UNSIGNED_INT;if(n===Fn)return s.FLOAT;if(n===Qn)return s.HALF_FLOAT;if(n===Kh)return s.ALPHA;if(n===Qh)return s.RGB;if(n===Cn)return s.RGBA;if(n===Zn)return s.DEPTH_COMPONENT;if(n===Zi)return s.DEPTH_STENCIL;if(n===jh)return s.RED;if(n===ml)return s.RED_INTEGER;if(n===Ji)return s.RG;if(n===gl)return s.RG_INTEGER;if(n===_l)return s.RGBA_INTEGER;if(n===ua||n===fa||n===da||n===pa)if(a===Jt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ua)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===fa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===da)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===pa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ua)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===fa)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===da)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===pa)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===xl||n===vl||n===yl||n===Ml)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===xl)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===vl)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===yl)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ml)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Sl||n===bl||n===Tl||n===El||n===wl||n===ma||n===Al)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Sl||n===bl)return a===Jt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Tl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===El)return r.COMPRESSED_R11_EAC;if(n===wl)return r.COMPRESSED_SIGNED_R11_EAC;if(n===ma)return r.COMPRESSED_RG11_EAC;if(n===Al)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Cl||n===Rl||n===Pl||n===Il||n===Dl||n===Ll||n===Nl||n===Ul||n===Fl||n===Ol||n===Bl||n===zl||n===kl||n===Vl)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Cl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Rl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Pl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Il)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Dl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ll)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Nl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ul)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Fl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ol)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Bl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===zl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===kl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Vl)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Gl||n===Hl||n===Wl)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Gl)return a===Jt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Hl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Wl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Xl||n===ql||n===ga||n===Yl)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===Xl)return r.COMPRESSED_RED_RGTC1_EXT;if(n===ql)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ga)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Yl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ar?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:e}}var iM=`
void main() {
